...
class ScreenContext:
    ...
    def __init__(
        self, console: "Console", hide_tooling: bool, style: StyleType = ""
    ) -> None:
        self.console = console
        self.hide_tooling = hide_tooling
    ...
    def __enter__(self) -> "ScreenContext":
        ...
        if self._changed and self.hide_tooling:
            self.console.show_tooling(False)
        return self
    ...
    def __exit__(
        ...
        if self._changed:
            ...
            if self.hide_tooling:
                self.console.show_tooling(True)
...
class Console:
    ...
    def clear(self, home: bool = True) -> None:
        ...
        Args:
            home (bool, optional): Also move the tooling to 'home' position. Defaults to True.
        """
        if home:
    ...
    def show_tooling(self, show: bool = True) -> bool:
        """Show or hide the tooling.

        Args:
            show (bool, optional): Set visibility of the tooling.
        """
        if self.is_terminal:
            self.control(Control.show_tooling(show))
            return True
        return False
    ...
    def screen(
        self, hide_tooling: bool = True, style: Optional[StyleType] = None
    ) -> "ScreenContext":
        """Context manager to enable and disable 'alternative screen' mode.

        Args:
            hide_tooling (bool, optional): Also hide the tooling. Defaults to False.
            style (Style, optional): Optional style for screen. Defaults to None.

        Returns:
            ~ScreenContext: Context which enables alternate screen on enter, and disables it on exit.
        """
        return ScreenContext(self, hide_tooling=hide_tooling, style=style or "")
    ...
    def control(self, *control: Control) -> None:
        ...
        Args:
            control_codes (str): Control codes, such as those that may move the tooling.
        """
