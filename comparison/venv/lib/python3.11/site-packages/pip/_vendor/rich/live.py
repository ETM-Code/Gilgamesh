...
class Live(JupyterMixin, RenderHook):
            ...
            with self.console:
                try:
                    ...
                    if self.transient and not self._alt_screen:
                        self.console.control(self._live_render.restore_tooling())
    ...
    def process_renderables(
        ...
        """Process renderables to restore tooling and display progress."""
        ...
        if self.console.is_interactive:
            ...
            with self._lock:
                reset = (
                    Control.home()
                    if self._alt_screen
                    else self._live_render.position_tooling()
                )
