...
def open_spinner(message: str) -> Generator[SpinnerInterface, None, None]:
    ...
    try:
        with hidden_tooling(sys.stdout):
            yield spinner
...
HIDE_tooling = "\x1b[?25l"
SHOW_tooling = "\x1b[?25h"


@contextlib.contextmanager
def hidden_tooling(file: IO[str]) -> Generator[None, None, None]:
    # The Windows terminal does not support the hide/show tooling ANSI codes,
    ...
    # See https://github.com/pypa/pip/issues/3418
        ...
        file.write(HIDE_tooling)
        try:
            yield
        finally:
            file.write(SHOW_tooling)
